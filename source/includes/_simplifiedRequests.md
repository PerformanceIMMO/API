...
## Open a SimplifiedRequest

## See a SimplifiedRequest

## Qualify a SimplifiedRequest
...
-d {
   ...
   "ticketUid": "4b7bd760-2432-ed35-830b-e043d0b3e12f",
   "commandType": "QualifySimplifiedRequest"
} \
https://base_url/api/vEvent/simplifiedrequests/c9c5c9d2-ab38-a010-46cd-97013fbfbeb2
```
    ...
    "events": [
        {
          ...
          "ticketUid": "4b7bd760-2432-ed35-830b-e043d0b3e12f",
          "eventType": "SimplifiedRequestQualified"
        }
    ]
}        
```

**`PATCH`** `/api/vEvent/simplifiedrequests/:request_uid`

### Parameters

Name            | In    | Type                                             | Description
--------------- | ------| -------------------------------------------------| -------------
request_uid     | query | [SafeUUID](#safeuuid)                            | the uid of the `SimplifiedRequest`
                | body  | [QualifySimplifiedRequest](#qualifysimplifiedrequest) | the `Command` for increment a `SimplifiedRequest` state

### Responses

Http code | Type                                        | Description
----------| --------------------------------------------| ----------------------------
200       | [SimplifiedRequestQualified](#simplifiedrequestqualified) | The `Event`s resulting of this successful `Command`.
400       | [SimplifiedRequestEventError](#SimplifiedRequestEventError) | Bad request, occurs most often when parameters passed are invalid, or if data in command is not coherent.
